...
fun main() {
    ...
    val biblioteca = GestorBiblioteca(RegistroPrestamos(), Catalogo())

    for (libro in listaLibros) {
        biblioteca.agregarLibro(libro)
    }

    println(biblioteca.prestar(listaLibros[1].obtnerId(), usuario1))
    println(biblioteca.prestar(listaLibros[1].obtnerId(), usuario2))

    println(biblioteca.devolver(listaLibros[1].obtnerId(), usuario1))
    println(biblioteca.devolver(listaLibros[2].obtnerId(), usuario1))
